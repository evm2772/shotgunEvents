...
export PYTHONPATH=${PYTHONPATH}:/fd/rnd_tools/ppline/prod/tools
...
/usr/autodesk/maya/bin/mayapy /fd/rnd_tools/ppline/prod/shotgunEvents/dkfx/scripts/export_tx.py "$@"
